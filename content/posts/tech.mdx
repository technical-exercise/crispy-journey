...
# Tech notes
  ...
  - Taking a cue from the XXX report, we could think about testing.
    Before procurement, were any assessments made as regards the effectiveness of these
    a possible facial recognition deployment? If not, will
  ...
  - How do these agencies plan to measure the success or failure of a
    facial recognition deployment? Do they have any plans for benchmarking?
  ...
  - I still have to think about the differences between the AWS *Celebrity
    ...
    <https://televisa.brightspotcdn.com/98/8d/2b72f51e490e91734509a5f3cbcd/05angelicarivera.jpg>
